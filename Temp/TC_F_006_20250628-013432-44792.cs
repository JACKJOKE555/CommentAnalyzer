...
/// <param name="count">[参数说明]</param>
/// <returns>[返回值说明]</returns>        // 缺少 param 和 returns 标签
...
/// <param name="input">[参数说明]</param>
/// <returns>[返回值说明]</returns>        // 缺少 typeparam, param, returns 标签
