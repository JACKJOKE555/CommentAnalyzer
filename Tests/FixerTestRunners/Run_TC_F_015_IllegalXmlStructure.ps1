# TC_F_015: 验证非法XML结构修复测试功能测试
# 测试策略: 修复后检测告警数是否为0

Write-Host "=== TC_F_015: 非法XML结构修复测试 ===" -ForegroundColor Cyan
...
$testFile = Join-Path $testCaseDir "FixerTestCases/TC_F_015_IllegalXmlStructure.cs"
$templateFile = Join-Path $testCaseDir "FixerTestCases/Templates/TC_F_015_IllegalXmlStructure.txt"
