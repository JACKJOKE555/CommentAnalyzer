<#
.SYNOPSIS
    Test case for analyzer rule: PROJECT_TYPE_MISSING_REMARKS (TC_A_002)
.DESCRIPTION
    ...
    missing a <remarks> tag.
#>

# --- Test Configuration ---
$TestName = "TC_A_002: Type Missing Remarks"
$RuleIdToFind = "PROJECT_TYPE_MISSING_REMARKS"
...
$TestCasePath = Join-Path $RepoRoot "CustomPackages/CommentAnalyzer/Tests/TestCases/TC_A_002_TypeMissingRemarks.cs"
...
$LogFilePath = Join-Path $PSScriptRoot "..\\..\\Logs\\TC_A_002_$(Get-Date -Format 'yyyyMMddHHmmss').log"
