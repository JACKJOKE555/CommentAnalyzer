<#
.SYNOPSIS
    Test case for analyzer rule: PROJECT_MEMBER_MISSING_PARAM (TC_A_006)
.DESCRIPTION
    This script runs the CommentAnalyzer on a specific test case file and verifies
    that the analyzer correctly identifies a method that is missing a <param> tag
    for one of its parameters.
#>

# --- Test Configuration ---
$TestName = "TC_A_006: Member Missing Param Tag"
$RuleIdToFind = "PROJECT_MEMBER_MISSING_PARAM"
...
$TestCasePath = Join-Path $RepoRoot "CustomPackages/CommentAnalyzer/Tests/TestCases/TC_A_006_MemberMissingParam.cs"
...
$LogFilePath = Join-Path $PSScriptRoot "..\\..\\Logs\\TC_A_006_$(Get-Date -Format 'yyyyMMddHHmmss').log"
