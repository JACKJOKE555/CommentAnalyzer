<#
.SYNOPSIS
    Test case for analyzer rule: PROJECT_MEMBER_MISSING_TYPEPARAM (TC_A_008)
.DESCRIPTION
    This script runs the CommentAnalyzer on a specific test case file and verifies
    that the analyzer correctly identifies a generic method that is missing a 
    <typeparam> tag.
#>

# --- Test Configuration ---
$TestName = "TC_A_008: Member Missing TypeParam Tag"
$RuleIdToFind = "PROJECT_MEMBER_MISSING_TYPEPARAM"
...
$TestCasePath = Join-Path $RepoRoot "CustomPackages/CommentAnalyzer/Tests/TestCases/TC_A_008_MemberMissingTypeParam.cs"
...
$LogFilePath = Join-Path $PSScriptRoot "..\\..\\Logs\\TC_A_008_$(Get-Date -Format 'yyyyMMddHHmmss').log"
