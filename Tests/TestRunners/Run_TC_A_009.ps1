<#
.SYNOPSIS
    Test case for analyzer rule: PROJECT_TYPE_NESTED_TYPE (TC_A_009)
.DESCRIPTION
    This script runs the CommentAnalyzer on a specific test case file and verifies
    that the analyzer correctly identifies a type that is nested inside another type.
#>

# --- Test Configuration ---
$TestName = "TC_A_009: Nested Type"
$RuleIdToFind = "PROJECT_TYPE_NESTED_TYPE"
...
$TestCasePath = Join-Path $RepoRoot "CustomPackages/CommentAnalyzer/Tests/TestCases/TC_A_009_NestedType.cs"
...
$LogFilePath = Join-Path $PSScriptRoot "..\\..\\Logs\\TC_A_009_$(Get-Date -Format 'yyyyMMddHHmmss').log"
