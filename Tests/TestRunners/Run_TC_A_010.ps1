<#
.SYNOPSIS
    Test case for analyzer rule: PROJECT_TYPE_NESTED_ENUM (TC_A_010)
.DESCRIPTION
    This script runs the CommentAnalyzer on a specific test case file and verifies
    that the analyzer correctly identifies an enum that is nested inside another type.
#>

# --- Test Configuration ---
$TestName = "TC_A_010: Nested Enum"
$RuleIdToFind = "PROJECT_TYPE_NESTED_ENUM"
...
$TestCasePath = Join-Path $RepoRoot "CustomPackages/CommentAnalyzer/Tests/TestCases/TC_A_010_NestedEnum.cs"
...
$LogFilePath = Join-Path $PSScriptRoot "..\\..\\Logs\\TC_A_010_$(Get-Date -Format 'yyyyMMddHHmmss').log"
