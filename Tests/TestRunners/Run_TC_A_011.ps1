<#
.SYNOPSIS
    Test case for analyzer rule: PROJECT_TYPE_MULTI_ENUM_FILE (TC_A_011)
.DESCRIPTION
    This script runs the CommentAnalyzer on a specific test case file and verifies
    that the analyzer correctly identifies when multiple enums are defined in the
    same file.
#>

# --- Test Configuration ---
$TestName = "TC_A_011: Multiple Enums In File"
$RuleIdToFind = "PROJECT_TYPE_MULTI_ENUM_FILE"
...
$TestCasePath = Join-Path $RepoRoot "CustomPackages/CommentAnalyzer/Tests/TestCases/TC_A_011_MultiEnumFile.cs"
...
$LogFilePath = Join-Path $PSScriptRoot "..\\..\\Logs\\TC_A_011_$(Get-Date -Format 'yyyyMMddHHmmss').log"
