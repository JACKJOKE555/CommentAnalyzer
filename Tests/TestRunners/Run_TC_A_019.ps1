<#
.SYNOPSIS
    Test case for analyzer rule: PROJECT_CONDITIONAL_COMPILATION_WARNING (TC_A_019)
.DESCRIPTION
    验证条件编译检测告警能力，断言为1。
#>

# --- Test Configuration ---
$TestName = "TC_A_019: Conditional Compilation Detection"
$RuleIdToFind = "PROJECT_CONDITIONAL_COMPILATION_WARNING"
$ExpectedDetections = 1
$TestCaseFile = "TC_A_019_ConditionalCompilationDetection.cs"
...
$LogFilePath = Join-Path $LogDir "TC_A_019_${JobId}.log"
...
Write-Host "Detected $detections $RuleIdToFind diagnostics."
